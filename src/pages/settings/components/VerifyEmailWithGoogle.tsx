...
const GOOGLE_AUTH_RELAY_MESSAGE_TYPE = 'suthraone-google-auth-relay';
...
const GOOGLE_AUTH_RELAY_URL = import.meta.env.VITE_GOOGLE_AUTH_RELAY_URL || 'https://restaurents.suthraone.com/google-auth-relay';
