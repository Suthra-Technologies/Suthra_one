                ...
                <Paper elevation={0} sx={{ p: { xs: 4, md: 8 }, borderRadius: 4, border: '1px solid rgba(0,0,0,0.08)' }}>
                    ...
                    <Box sx={{ '& > p': { mb: 2, lineHeight: 1.7, color: 'text.secondary' }, '& > h2': { mt: 6, mb: 3, fontWeight: 700 }, '& > h3': { mt: 4, mb: 2, fontWeight: 600 } }}>
                        ...
                        <Box component="ul" sx={{ color: 'text.secondary', pl: 3, mb: 2 }}>
                            <Box component="li" sx={{ mb: 1 }}><strong>Application</strong> means the software program provided by the Company downloaded by You on any electronic device, named NexZen POS</Box>
                            ...
                            <Box component="li" sx={{ mb: 1 }}><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in these Terms and Conditions) refers to NexZen POS.</Box>
                        ...
                        <Box component="ul" sx={{ color: 'text.secondary', pl: 3, mb: 2 }}>
                            <Box component="li">By email: contact@nexzenpos.com</Box>
                            <Box component="li">By visiting this page on our website: <Link href="https://nexzenpos.com/" target="_blank" rel="noopener">https://nexzenpos.com/</Link></Box>
                        </Box>
                    </Box>
                </Paper>
            </Container>
