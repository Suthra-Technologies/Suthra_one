                ...
                <Paper elevation={0} sx={{ p: { xs: 4, md: 8 }, borderRadius: 4, border: '1px solid rgba(0,0,0,0.08)' }}>
                    ...
                    <Box sx={{ '& > p': { mb: 2, lineHeight: 1.7, color: 'text.secondary' }, '& > h2': { mt: 6, mb: 3, fontWeight: 700 }, '& > h3': { mt: 4, mb: 2, fontWeight: 600 } }}>
                        ...
                        <Box component="ul" sx={{ color: 'text.secondary', pl: 3, mb: 2 }}>
                            ...
                            <Box component="li" sx={{ mb: 1 }}><strong>Application</strong> refers to NexZen POS, the software program provided by the Company.</Box>
                            <Box component="li" sx={{ mb: 1 }}><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Privacy Policy) refers to NexZen POS.</Box>
